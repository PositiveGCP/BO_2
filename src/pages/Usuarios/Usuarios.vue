...
export default {
 ...
 return{
  headers: [
          ...
          { text: 'DATOS GENERALES', align: 'left', value: 'name'},
          { text: 'CORREO ELECTRONICO', value: 'contacto' },
